...
from DQN.tf_util import load_variables, save_variables
...
from DQN.tf_util import get_session
from DQN.models import build_q_func
import DQN.build_graph as build_graph
...
def learn(env,
    ...
    **network_kwargs
    ...
    exploration = LinearSchedule(schedule_timesteps=int(exploration_fraction * total_timesteps), initial_p=1.0, final_p=exploration_final_eps)
