...
class SuperMarioBrosEnv(NESEnv):
    ...
    def __init__(self, rom_mode='vanilla', lost_levels=False, target=(1,1)):
        """
    ...
    def _score_reward(self):
        """Return the reward based on left right movement between steps."""
        if (self._score - self._score_last == 100):
        ...
        elif (self._score - self._score_last == 200):
        ...
        elif (self._score_last - self._score == 1000):
    ...
    def _get_reward(self):
        ...
        return self._x_reward + self._time_penalty + self._death_penalty + self._score_reward + 10*(self._flag_get)

    def _get_done(self):
        """Return True if the episode is over, False otherwise."""
        if self.is_single_stage_env:
            return self._is_dying or self._is_dead or self._flag_get or (self._time==250)
